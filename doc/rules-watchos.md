...
| <a id="watchos_application-app_intents"></a>app_intents |  List of dependencies implementing the AppIntents protocol.<br><br>Multiple app_intents dependencies are supported on Xcode 26 and later. If multiple dependencies are provided, AppShortcutsProvider is recognized only when it is defined in the first dependency.   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
...
| <a id="watchos_extension-app_intents"></a>app_intents |  List of dependencies implementing the AppIntents protocol.<br><br>Multiple app_intents dependencies are supported on Xcode 26 and later. If multiple dependencies are provided, AppShortcutsProvider is recognized only when it is defined in the first dependency.   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
